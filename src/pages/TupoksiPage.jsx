        ...
        <div className="bg-base-200 py-28 px-4 sm:px-32">
            ...
            <div className="mt-4">
                ...
                <ul className="list-disc list-inside mb-4">
                    ...
                    <li>Menyiapkan konsep kebijakan Kelurahan sebagai pedoman pelaksanaan tugas.</li>
                    <li>Mengoordinasikan penyelenggaraan program dan kegiatan Kelurahan.</li>
                    <li>Melaksanakan sebagian urusan pemerintahan yang dilimpahkan oleh Bupati.</li>
                    <li>Mengarahkan kegiatan monitoring wilayah kerja kelurahan.</li>
                    <li>Menyusun laporan pelaksanaan tugas sebagai informasi kepada pimpinan.</li>
                </ul>
            </div>
            ...
            <div className="mt-4">
                ...
                <ul className="list-disc list-inside mb-4">
                    ...
                    <li>Mengoordinasikan pengelolaan administrasi umum dan kepegawaian.</li>
                    <li>Menyelenggarakan Sistem Pengendalian Intern Pemerintah (SPIP).</li>
                    <li>Menyusun laporan pelaksanaan tugas sebagai informasi kepada pimpinan.</li>
                </ul>
            </div>
            ...
            <div className="mt-4">
                ...
                <ul className="list-disc list-inside mb-4">
                    ...
                    <li>Melaksanakan kegiatan koordinasi, pembinaan, dan pengawasan.</li>
                    <li>Menyusun laporan pelaksanaan tugas sebagai informasi kepada pimpinan.</li>
                </ul>
            </div>
            ...
            <div className="mt-4">
                ...
                <ul className="list-disc list-inside mb-4">
                    ...
                    <li>Melaksanakan kegiatan koordinasi dan pembinaan.</li>
                    <li>Menyusun laporan pelaksanaan tugas sebagai informasi kepada pimpinan.</li>
                </ul>
            </div>
