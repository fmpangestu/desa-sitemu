    ...
    return (
        <div className="container min-h-screen bg-base-200">
            <div className="mx-auto pt-20 lg:pt-44 px-4 sm:px-16 lg:px-36 flex flex-col lg:flex-row justify-between items-start">
                {/* Informasi Kontak */}
                <aside className="w-full lg:w-1/2 mb-6 lg:mb-0" data-aos="fade-right">
                    ...
                    <p className="mb-4 font-semibold">WhatsApp: <span className="italic font-normal"> +62 838-6639-8265</span></p>
                    {/* <p className="mb-2 font-semibold">Email: <span className="italic font-normal"> kantor.desasitemu@domain.com</span></p> */}
                    <p className="mb-4 font-semibold">Jam Operasional:<span className="italic font-normal"> Senin-Jumat, 08.00 - 14.00</span></p>
                </aside>
